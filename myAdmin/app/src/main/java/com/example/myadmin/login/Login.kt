...
import com.example.myadmin.databinding.FragmentLoginBinding
                    ...
                    viewModel.user.observe(requireActivity(), Observer{ user ->
                        if (user!=null) {
                            if (user.success == true) {
                                ...
                                saveName(user.data.result.name!!)
                              //  saveRefreshToken(user.data.refreshtoken!!)
                                ...
                                Navigation.findNavController(v).navigate(R.id.action_login_to_homeActivity)
